 ...
 public:
  ...
  class Iterator {
   ...
   public:
    ...
    Iterator(Func& f, iterator_t<ContainerT>&& sub_iter)
  ...
  Iterator<Container> begin() { return {func_, get_begin(container_)}; }

  Iterator<Container> end() { return {func_, get_end(container_)}; }
