...
class CVMFileLogger : public CVMLogger {
	...
	public:
		...
		CVMFileLogger(const std::string& outfilename, std::shared_ptr<CVMOptimizerDataHolder> data);
		void log() override;
	private:
...
class CVMSolverLogger : public CVMLogger {
	public:
		...
		CVMSolverLogger(const std::string& outfilename, std::shared_ptr<CVMOptimizerDataHolder> data);
		void log() override;
	private:
		std::shared_ptr<CVMOptimizerDataHolder> data_;
