...
// use the stream s to initialize the variables pointed to in the array
// questions of lenght nb;
int get_values(istream &s, int nb, AskStruct *label);
// use argc and argv to initialize the variables pointed to in the array
// questions of lenght nb;
