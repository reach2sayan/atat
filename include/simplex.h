...
class Simplex {
	...
	private:
		...
		MatrixXd get_inverse_base_matrix(const MatrixXd& A, const VectorXd basic_vars);
		VectorXd get_simplex_mults(const MatrixXd& inverse_base, const VectorXd& costs, const VectorXd& basic_vars);
