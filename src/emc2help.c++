char *helpstring =
    ...
    "\n"
    "-dmu : chemical potential step (expressed in the same units as mu0 and "
    "mu1).\n"
    "\n"
    "NOTE: If mu1 is omitted, only a scan through T is performed keeping "
    "mu=mu0.\n"
    ...
    "        potential of given by either the 1-spin Low Temperature "
    "Expansion\n"
    ...
    "\n"
    "-dx: instead of specifying -eq and -n, you can ask the code to "
    "equilibrate\n"
    ...
    "         undetected, first try to reduce dT or dmu or increase n or "
    "decrease dx\n"
    ...
    "gs_str.out   : a list of ground states, in increasing order of "
    "concentration.\n"
    "\n"
    ...
    "Optional input file:\n"
    "\n"
    "teci.out     : if present, provides temperature-dependent eci (overrides "
    "eci.out)\n"
    "               (Note that, even when the teci.out file is used, column 6 "
    "of the output file\n"
    "                reflects only the configurational contribution to the "
    "heat capacity.)\n"
    "\n"
    ...
    "\n"
    "Note that these numbers can be seperated by blanks or newlines, as "
    "desired.\n"
    "\n"
    ...
    "\n"
    " 1) T:  Temperature\n"
    " 2) mu: chemical potential (derivative of the free energy wrt to average "
    "spin)\n"
    ...
    "12) x_mf\n"
    "13) phi_mf\n"
    "14) E_hte-mu*x_hte: calculated with a High Temperature Expansion (ideal "
    "solution + polynomial in x)\n"
    "15) x_hte\n"
    "16) phi_hte\n"
    "17) lro: Long Range Order parameter of the initial ordered phase (=0 if "
    "initial phase is disordered).\n"
