...
void diff(Array2d<Real> *result, const Array2d<Real> &a,
...
void sum(Array2d<Real> *result, const Array2d<Real> &a,
         const Array2d<Real> &b) {
#ifdef DEBUG
  if (a.get_size() != b.get_size())
    ERRORQUITDUMP("Matrices not conformable");
...
void sum(Array2d<Complex> *result, const Array2d<Complex> &a,
...
void product(Array2d<Real> *result, const Array2d<Real> &a,
             const Array2d<Real> &b) {
#ifdef DEBUG
...
void product_diag(Array2d<Real> *result, const Array<Real> &diag,
                  const Array2d<Real> &b) {
#ifdef DEBUG
  if (diag.get_size() != b.get_size()(0))
    ERRORQUITDUMP("Matrices not conformable");
#endif
...
void product_diag(Array2d<Real> *result, const Array2d<Real> &b,
                  const Array<Real> &diag) {
#ifdef DEBUG
  if (diag.get_size() != b.get_size()(1))
    ERRORQUITDUMP("Matrices not conformable");
#endif
  result->resize(b.get_size());
  for (int i = 0; i < b.get_size()(0); i++) {
...
void product_diag(Array<Real> *result, const Array<Real> &diag,
                  const Array<Real> &b) {
#ifdef DEBUG
  if (diag.get_size() != b.get_size())
    ERRORQUITDUMP("Matrices not conformable");
#endif
  result->resize(b.get_size());
...
void product(Array<Real> *result, const Array2d<Real> &a,
             const Array<Real> &b) {
#ifdef DEBUG
...
void product(Array<Real> *result, const Array<Real> &a,
             const Array2d<Real> &b) {
#ifdef DEBUG
  if (a.get_size() != b.get_size()(0))
    ERRORQUITDUMP("Matrices not conformable");
#endif
...
void inner_product(Array2d<Real> *result, const Array2d<Real> &a,
                   const Array2d<Real> &b) {
#ifdef DEBUG
  ...
  cblas_dgemm(CblasColMajor, CblasTrans, CblasNoTrans, m, n, k, 1.,
              a.get_buf_c(), k, b.get_buf_c(), k, 0., result->get_buf(), m);
}
...
void inner_product(Array<Real> *result, const Array2d<Real> &a,
                   const Array<Real> &b) {
#ifdef DEBUG
  if (a.get_size()(0) != b.get_size())
    ERRORQUITDUMP("Matrices not conformable");
#endif
...
void outer_product(Array2d<Real> *result, const Array2d<Real> &a,
                   const Array2d<Real> &b) {
#ifdef DEBUG
  if (a.get_size()(1) != b.get_size()(1))
    ERRORQUITDUMP("Matrices not conformable");
#endif
...
void outer_product(Array2d<Real> *result, const Array<Real> &a,
                   const Array<Real> &b) {
...
void outer_product_diag(Array<Real> *result, const Array2d<Real> &a,
                        const Array2d<Real> &b) {
#ifdef DEBUG
  if (a.get_size()(1) != b.get_size()(1))
    ERRORQUITDUMP("Matrices not conformable");
  if (a.get_size()(0) != b.get_size()(0))
    ERRORQUITDUMP("Matrix is not square");
#endif
  result->resize(a.get_size()(0));
  zero_array(result);
  for (int i = 0; i < a.get_size()(0); i++) {
...
#ifdef DEBUG
  if (a.get_size()(0) != a.get_size()(1))
    ERRORQUITDUMP("Cannot take trace of nonsquare matrix");
#endif
  Real tr = 0;
  for (int i = 0; i < a.get_size()(0); i++) {
    tr += a(i, i);
...
Real norm(const Array<Real> &v) { return sqrt(inner_product(v, v)); }

Real norm2(const Array<Real> &v) { return inner_product(v, v); }
