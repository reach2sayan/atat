const char *helpstring =
    ""
    "This code creates an APB from a given structure file and computes its "
    "APB\n"
    "energy using ECIs.\n"
    "\n"
    "Reference:\n"
    ...
    "      T3x T3y T3z\n"
    "\n"
    "* The APB structure is generated by duplicating atoms along T3 and "
    "shifting\n"
    "  them by the slip vector.\n"
    "\n"
    "* To obtain the APB energy, the user should first perform a cluster "
    "expansion\n"
    "  on the system and provide clusters.out and eci.out as input.\n"
    "\n"
    "* In Monte Carlo mode, the concentration of the initial structure is "
    "fixed in\n"
    "  conccons.in. The temperature and number of averaging steps are used to "
    "write\n"
    "  control.in. The file name of the perfect and defective structures MC "
    "snapshot\n"
    "  is str????.out and str????_apb.out, respectively. After MC, the APBs "
    "are\n"
